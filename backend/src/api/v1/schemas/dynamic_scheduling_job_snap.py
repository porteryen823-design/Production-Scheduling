...
class DynamicSchedulingJobSnapBase(BaseModel):
    key_value: str
    remark: Optional[str] = None


class DynamicSchedulingJobSnapCreate(DynamicSchedulingJobSnapBase):
    pass


class DynamicSchedulingJobSnapResponse(DynamicSchedulingJobSnapBase):
    id: int
